    ...
    <div className="group bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 animate__animated animate__fadeInUp">
      ...
      <div className="p-4 flex flex-col gap-2">
        ...
        <div className="flex items-center justify-between mt-2">
          ...
          <p className="text-xs text-gray-500">{tile.dimensions}</p>
        </div>

        <Link href={`/all-tiles/${tile.id}`}>
          <button className="mt-3 w-full bg-blue-600 text-white py-2.5 rounded-xl hover:bg-blue-700 transition-all duration-300 shadow-md cursor-pointer group-hover:shadow-blue-200">
            View Details
          </button>
        </Link>
      </div>
