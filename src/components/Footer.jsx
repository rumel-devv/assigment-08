  ...
  return (
    <footer className="bg-gray-100 mt-10 ">
      <div className="w-full md:w-10/12 mx-auto px-4 py-10 grid md:grid-cols-4 gap-8">
        <div>
          <h2 className="text-2xl font-bold text-purple-700">TilesMart</h2>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-600 text-sm">
            ...
            <li><Link href="/all-tiles" className="hover:text-purple-600">All Tiles</Link></li>
            <li><Link href="/profile" className="hover:text-purple-600">Profile</Link></li>
          </ul>
        </div>
        <div>
